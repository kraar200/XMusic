    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            if (
                ...
                return await mystic.edit_text(
                    "لا يمكن لهذا البوت تشغيل مسارات وقوائم تشغيل Spotify ، يرجى الاتصال بالمالك واطلب منه إضافة مشغل Spotify ."
                )
            if "track" in url:
                try:
            ...
            try:
                ...
                await mystic.edit_text(
                    "هناك خطأ في البوت ، يرجى الإبلاغ عنه الدعم في أسرع وقت ممكن ."
                )
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    "يرجى تشغيل دردشة الفيديو لبدء التشغيل .",
                )
            except Exception as e:
                return await mystic.edit_text(
...
async def anonymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
            "أنت مسؤول مجهول\n\nالعودة إلى حساب المستخدم لاستخدامي .",
            show_alert=True,
        )
    except:
        return
