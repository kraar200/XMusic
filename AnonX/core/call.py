    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**لم يتم العثور على دردشة فيديو نشطة**\n\nيرجى التأكد من بدء دردشة الفيديو ."
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**مساعد بالفعل في دردشة الفيديو**\n\nاكتشفت أنظمة بوت الموسيقى أن المساعد موجود بالفعل في دردشة الفيديو ، إذا استمرت هذه المشكلة ، فأعد تشغيل دردشة الفيديو وحاول مرة أخرى ."
            )
        except TelegramServerError:
            raise AssistantErr(
                "**خطآ في خادم تلجرام**\n\nيرجى إيقاف تشغيل دردشة الفيديو وإعادة تشغيلها مرة أخرى ."
            )
